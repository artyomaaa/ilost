    ...
    e.fn.classyNav = function (n) {
        ...
        return this.each(function () {
            ...
            "light" !== c.theme && "dark" !== c.theme || a.addClass(c.theme), "left" !== c.openMobileMenu && "right" !== c.openMobileMenu || a.addClass(c.openMobileMenu), !0 === c.dropdownRtl && a.addClass("dropdown-rtl"), l.on("click", function () {
                ...
                e(this).next().length > 0 && (e(this).parent("li").append('<span class="dd-trigger"></span>'), e(this).parent("li").append('<span class="dd-arrow"></span>'))
            ...
            }), e(".megamenu-item, .cn-dropdown-item").addClass("pr12"), e(".megamenu-item"), s.find("li .dd-trigger").on("click", function (n) {
