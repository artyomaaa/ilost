...
<div style="padding: 50px 100px">
    ...
    <h1 style="text-align: center; color:#4659B0;margin-top: 0; margin-bottom: 65px">Confirm your email address change</h1>
    <p style="color: #4659B0; font-size: 16px; margin-bottom: 40px">
        You are trying to change your email at iLost. Please confirm.    </p>
