        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <div class="hero-content">
                    ...
                    <h2 style="color: white"> Կորցրած և Գտնված ապրանքների հարթակ </h2>
                    <a href="#" style="color: white" class="btn essence-btn"
                       id="<?= (!empty($user_id)) ? "myBtn" : "open-login-modal" ?>">Ավելացնել
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="section-heading text-center">
                    <?php if (!empty($statements)) { ?>
                        <h2>Վերջին կորցրած ապրանքները</h2>
                    <?php } ?>
                </div>
            </div>
        </div>
...
<section class="new_arrivals_area section-padding-80 clearfix" style="margin-bottom: 120px">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-heading text-center">
                    <?php if (!empty($findThing)) { ?>
                        <h2>Վերջին գտած ապրանքները</h2>
                    <?php } ?>
                </div>
            </div>
        </div>
