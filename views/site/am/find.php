                            ...
                            <ul id="menu-content2" class="menu-content collapse show">
                                ...
                                <li data-toggle="collapse" data-target="#clothing">
                                    <a href="/category/?category_name=cloths&category=find" id="cloths"
                                       style="color: <?= (!empty($category_name) && $category_name === 'cloths') ? '#0c83e2' : '#787878' ?>">Հագուստ և աքսեսուարներ</a>
                                </li>
                                <!-- Single Item -->
                                ...
                                <!-- Single Item -->
                                <li data-toggle="collapse" data-target="#accessories&category=find" class="collapsed">
                                        ...
                                        <div class="slider-range">
                                            <form action="/category/search-in-category" type="get">
                                                <div class="search-input">
                                                    ...
                                                    <input type="text" id="" name="search_category" placeholder="Փնտրել.."/>
