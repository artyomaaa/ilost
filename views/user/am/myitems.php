                        ...
                        <div class="col-12 col-lg-6">
                            <div class="single-blog-area mb-50">
                                ...
                                <div class="hover-content">
                                    ...
                                    <a href="/post/edit?id=<?= $myLostItemsValue->id ?>&contact=lost">Փոփոխել
                                        &nbsp;ապրանքը </a>
                                    <a href="#" class="delete-item" data-id="<?= $myLostItemsValue->id ?>"
                                       id="delete-item"
                                       data-toggle="modal" data-target="#myModal">Ջնջել &nbsp;ապրանքը</a>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="single-blog-area mb-50">
                                ...
                                <div class="hover-content">
                                    ...
                                    <a href="/post/edit?id=<?= $myFindItemsValue->id ?>&contact=find">Փոփոխել
                                        &nbsp;ապրանքը </a>

                                    <a href="#" class="delete-item" id="delete-item"
                                       data-id="<?= $myFindItemsValue->id ?>"
                                       data-toggle="modal" data-target="#myModal">Ջնջել &nbsp;ապրանքը</a>
                                    <!-- Modal -->
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Ջնջել ապրանքը</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>

                </div>
                <div class="modal-body">
                    <p>Ցանկանոու՞մ եք ջնջել ապրանքը...</p>
                    <!--                <span style="display: none" id="item-id"></span>-->
                    <!--                <span style="display: none" id="item-contact"></span>-->
                </div>
                <div class="modal-footer">
                    <a href="" id="item-id" style="background-color: red">Ջնջել</a>
                    <a href="" style="background-color: #0c83e2">Չեղարկել</a>
                </div>
            </div>
...
<?php if (empty($myFindItems) && empty($myLostItems)) { ?>
    <div class="no-item">
        <div>
            <h3>Դուք դեռևս չունեք ավելացված հայտարարություններ։</h3>
        </div>
    </div>
<?php } ?>